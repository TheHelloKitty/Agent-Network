...
def post_network_status_report(active_nodes_count):
    ...
    # Posts report 3 times a day during the closest cycles to 00:00, 08:00, and 16:00 UTC
...
"""
    ...
    if isinstance(existing_issues, list) and any(issue.get("title") == report_title for issue in existing_issues if isinstance(issue, dict)):
        return
