...
def write_full_novel(agent_name, category_key, topic):
    ...
    try:
        ...
        outline = "Title: Untitled\nBlurb: Draft in progress.\nCharacters: TBD\nOutline: Chapter plan pending."
...
def refine_book(txt_path):
    ...
    try:
        character_bible = generate_with_fallback(bible_prompt, temperature=0.4)
    except Exception as e:
        print("Bible failed:", e)
        character_bible = "Character bible unavailable."
    ...
    for i, chunk in enumerate(chunks, start=1):
        ...
        try:
            edited = generate_with_fallback(prompt, temperature=0.5)
        except Exception as e:
