...
def write_fleet_report():
    ...
    lines = [
        ...
        "Books completed: %s" % len(books_completed),
        "Books refined / successful polish passes: %s" % len(refined_books),
